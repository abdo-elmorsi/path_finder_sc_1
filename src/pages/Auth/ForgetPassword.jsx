...
function ForgetPassword() {
    ...
    const [email, setEmail] = useState(null); // decleare a state for save user information on it
                ...
                >
                    ...
                    >
                        ...
                        {inputsData.map((input, index) => (
                            <Inputs
                                setUser={setEmail} // send setUserReg (function to change on state) props =>>in parent of input
                                user={email}
                                key={index}
