...
function ResetPassword() {
    ...
    const [password, setPassword] = useState({}); // decleare a state for save user information on it
                ...
                >
                    ...
                    >
                        ...
                        {inputsData.map((input, index) => (
                            <Inputs
                                key={index}
                                setUser={setPassword} // send setPassword (function to change on state) props =>>in parent of input
                                user={password}
